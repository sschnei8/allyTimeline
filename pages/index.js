...
export default function Home() {
  const imageData = [
      ...
      { src: "/images/today_1.jpeg", caption: "Squinty Face"},
      { src: "/images/today_2.jpeg", caption: "My glasses!"},
      { src: "/images/today_3.jpeg", caption: "Will you admit this is a good photo of you?"},
      { src: "/images/today_4.jpeg", caption: "Another good photo..."},
      { src: "/images/today_5.jpeg", caption: "Time to drill"},
      { src: "/images/today_6.jpeg", caption: "9-11 on the Fourth of July!"},
      { src: "/images/today_7.jpeg", caption: "A little dehydrated meatball"},
  ...
  return (
    <div className="container"> 
      ...
      <main>
        ...
        <p>I spun up a boiler plate next.js app, created a development server using NPM, cloned the github repo onto 
        ...
        <p>Then I realized, I dont have great design skills, I'm not a web dev, and the more fancy shit I add to this site the worse it's going 
          to look and the more meaning it will lose... haha. 
        </p>
        <p>So I've kept it pretty straightforward. I've positioned the photos a bit, and added a small caption of what the photo reminded me of and a 
          ...
          down in Tucson and stole your heart by complimenting your Go-Yard bag. You are passionate and thoughtful in both work and your relationships. You are going to do great in med school, and I'm
